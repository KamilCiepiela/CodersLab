Feature: Registration on CodersGuru as a private user
  ...
  Scenario Outline: User registers as a private user
    ...
    Examples:
      ...
      | karol.kowalski1@mailinator.com | Karol              | Kowalski          | Pass123           | Pass123                 | Warszawa      | 00-020       | Prosta          | 51/69               |
      | adam.nowak1@mailinator.com     | Adam               | Nowak             | 321Pass           | 321Pass                 | Warszawa      | 00-050       | Krzywa          | 1/4                 |